...
- The user may write Mongolian in Latin letters ("orlogo Bataagaas 2 say belen" is «орлого
  Батаагаас 2 сая бэлэн»: revenue from Батаа, 2 000 000, paid in cash). Read it as Mongolian:
  "orlogo" is income, "zardal" is an expense, "say" is сая (a million), "myanga" is мянга (a
  thousand), "belen" is cash, "dans" is a bank account, "tolson" is paid, "orloo" is came in.
  Write names back in Cyrillic when you can, and never treat Latin spelling as a reason to
  ask an admin.
