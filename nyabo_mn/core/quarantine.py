...
_INJECTION_PATTERNS: tuple[re.Pattern[str], ...] = tuple(
	...
	for p in (
		...
		r"(шууд|заавал|яаралтай|асуулгүй|шалгалгүй)\s+(батал|зөвшөөр|бүртгэ)",
		r"\bбатлах\s+(товч|команд|үйлдлийг)",
		r"батал(на\s+уу|аарай|ж\s+өг|ах\s+хэрэгтэй)\b",
		r"нягтлан(д|гүй)\s+(хэлэлгүй|мэдэгдэлгүй|шалгуулалгүй)",
		r"(шалга|баталгаажуул)(ах|лт)?\s*(хэрэггүй|шаардлагагүй)",
