...
# --- rich cards: dashboard, transactions, bank, reports, answers (telegram.richcards) ------------
# Every card is a Bot API 10.3 rich message (headings, tables, details, styled buttons) with a
# plain-text twin for clients that cannot draw one; these strings are read in both drawings.
CARD_DASHBOARD_TITLE = "{company} · Хяналтын самбар"
CARD_DASHBOARD_DATE = "{date} · {period}"
CARD_MONTH_HEADING = "Энэ сар · {period}"
CARD_REVENUE = "Орлого"
CARD_EXPENSE = "Зардал"
CARD_PROFIT = "Ашиг"
CARD_DELTA = "{sign}{pct}% өмнөх сараас"
CARD_DELTA_NONE = "өмнөх сард бичилт байгаагүй"
CARD_MONTH_EMPTY = "Энэ сард бичилт алга — эхний баримт эсвэл банкны хуулга ирмэгц энд тоо гарна."
CARD_BANKS_HEADING = "Банк, касс"
CARD_COL_RECON = "Тулгалт"
CARD_RECON_OK = "тулгагдсан"
CARD_RECON_UNMATCHED = "{count} тулгаагүй"
CARD_RECON_NO_STATEMENT = "хуулга ирээгүй"
CARD_YOUR_TURN = "Таны ээлж"
CARD_TODO_PROPOSALS = "{count} баримт баталгаажуулахыг хүлээж байна"
CARD_TODO_UNMATCHED = "{count} банкны гүйлгээ тулгах"
CARD_TODO_RULES = "{count} дүрэм баталгаажаагүй (/дүрэм)"
CARD_TODO_NONE = "Хүлээгдэж буй ажил алга"
CARD_COMMANDS = "Командууд"
CARD_FOOT_LEDGER = "Тоо бүр ERPNext дэвтрээс · {time}"
CARD_FOOT_COMPUTED = "Тоо бүрийг дэвтрээс тооцов"
CARD_SECTION_FAILED = "Зарим хэсгийг уншиж чадсангүй; алдааг бүртгэлээ."
BTN_DASHBOARD = "Самбар"
BTN_TRANSACTIONS = "Гүйлгээ"
BTN_BANK = "Банк"
BTN_REPORTS = "Тайлан"
BTN_PROPOSALS = "Баримтууд ({count})"
BTN_REFRESH = "Шинэчлэх"
BTN_SHOW = "Харах"
BTN_RECONCILE = "Тулгах"
BTN_SEND_STATEMENT = "Хуулга илгээх"
BTN_PDF = "PDF"
BTN_XLSX = "Excel"
# transactions
CARD_TX_TITLE = "Гүйлгээ · {period}"
CARD_TX_META = "{count} баримт · зарлага {outflow}₮ · орлого {inflow}₮"
CARD_TX_NONE = "{period}: бүртгэгдсэн гүйлгээ алга."
CARD_TX_SHOWN = "Сүүлийн {shown} баримт; сарын нийт {count}."
CARD_COL_STATUS = "Төлөв"
CARD_STATUS_POSTED = "Батлагдсан"
CARD_STATUS_PENDING = "Хүлээгдэж буй"
CARD_PENDING_HEADING = "Хүлээгдэж буй ({count})"
CARD_PENDING_TITLE = "Хүлээгдэж буй баримт ({count})"
CARD_PENDING_NONE = "Баталгаажуулах баримт алга."
CARD_PENDING_LINE = "{date} · {label} · {total}₮"
CARD_PENDING_HINT = "«Харах» дарахад баримтын карт дахин ирнэ — тэндээс батална."
# bank balances
CARD_BANK_TITLE = "Банкны үлдэгдэл · {date}"
CARD_COL_LEDGER = "Дэвтэр"
CARD_COL_STATEMENT = "Хуулга"
CARD_COL_DIFF = "Зөрүү"
CARD_BANK_DIFF_NOTE = "{bank}: хуулга ба дэвтрийн зөрүү {diff}₮; тулгаагүй гүйлгээ: {count}."
CARD_BANK_ALL_MATCHED = "Бүх данс тулгагдсан."
CARD_BANK_SOURCE = "Хуулга: {date} · Дэвтэр: одоо"
CARD_STATEMENT_HINT = "Банкны хуулгаа Excel эсвэл CSV файлаар энд илгээнэ үү — тулгалт шууд эхэлнэ."
CARD_UNMATCHED_NONE = "Тулгаагүй банкны гүйлгээ алга."
CARD_UNMATCHED_SENT = "Тулгаагүй {count} гүйлгээний картыг илгээлээ."
# reports
CARD_REPORTS_TITLE = "Тайлан"
CARD_REPORTS_HINT = (
	"Бэлэн тайланг сонгох, эсвэл асуултаа энгийн үгээр бичээрэй — жишээ нь «сүүлийн 6 сарын орлого»."
)
CARD_REPORTS_FOOT = "Тайлант үе: {period}"
BTN_R_PL = "Орлого, зардал"
BTN_R_INVENTORY = "Бараа материал"
BTN_R_TREND = "Орлогын чиглэл"
BTN_R_UNMATCHED = "Тулгаагүй гүйлгээ"
CARD_TREND_TITLE = "Орлогын чиглэл · {from_period} – {to_period}"
CARD_COL_CHANGE = "Өөрчлөлт"
CARD_TREND_BEST = "Хамгийн өндөр сар: {period} — {amount}₮."
CARD_TREND_NONE = "Сүүлийн {months} сард орлогын бичилт алга."
CARD_TOP_TITLE = "Хамгийн том зардал · {period}"
CARD_TOP_SENTENCE = "Хамгийн их зардал: {account} — {amount}₮, нийт зардлын {pct}%."
CARD_TOP_NONE = "{period}: зардлын бичилт алга."
CARD_TOP_MORE = "Нийт {count} дансанд зардал гарсан; хамгийн том {shown} дансыг харуулав."
CARD_TB_TITLE = "Гүйлгээ баланс · {period}"
CARD_TB_TOTALS = "Дебет {debit}₮ · Кредит {credit}₮"
CARD_TB_MORE = "Нийт {count} данс; дүнгээр хамгийн том {shown} дансыг харуулав. Бүтнийг PDF-ээр авна."
CARD_PL_TITLE = "Орлого, зардал · {period}"
CARD_PL_NONE = "{period}: орлого, зардлын бичилт алга."
# inventory
CARD_INV_TITLE = "Бараа материал · {date}"
CARD_COL_ITEM = "Бараа"
CARD_COL_QTY = "Тоо"
CARD_COL_RATE = "Өртөг"
CARD_INV_NONE = "Бараа материалын үлдэгдэл алга."
CARD_INV_MORE = "Нийт {count} бараа; өртгөөр хамгийн том {shown} барааг харуулав."
CARD_INV_SOURCE = "Stock Ledger · өртгийн арга: компанийн бодлого §4"
# the answer card and its streamed draft
CARD_THINKING = "Бодож байна…"
CARD_THINKING_READING = "Дэвтрээс уншиж байна…"
CARD_COL_ENTRY = "Баримт"

# --- the onboarding wizard as one card, and the welcome card (telegram.richcards) ------------------
ONB_CARD_TITLE = "Тохиргоо · {company}"
ONB_CARD_STEP = "Алхам {n}/{total}"
ONB_STEP_LABELS = ["НӨАТ", "Орлого", "Банк", "Валют, данс", "Бараа материал", "Нягтлан", "Батлах"]
ONB_ANSWERED = "Хариулсан"
ONB_A_VAT = "НӨАТ төлөгч: {answer}"
ONB_A_400M = "2027 онд орлого 400 сая₮-с бага: {answer}"
ONB_A_BANKS = "Банк: {banks}"
ONB_A_BANK_CURRENCIES = "{bank}: {currencies}"
ONB_A_INVENTORY = "Бараа материал: {inventory}"
ONB_A_ACCOUNTANT = "Нягтлан: {accountant}"
ONB_CARD_FOOT = "Хариулт бүр буцаах боломжтой · баталгаажуулах хүртэл юу ч бүртгэгдэхгүй"
ONB_DONE_TITLE = "Тохиргоо дууслаа"
ONB_DONE_NEXT = (
	"Одоо эхний баримтаа илгээгээрэй — зураг авахад л хангалттай. Банкны хуулгаа Excel эсвэл CSV "
	"файлаар илгээвэл тулгалт шууд эхэлнэ."
)
WELCOME_TITLE = "Сайн байна уу, би Нябо"
WELCOME_COL_YOU = "Та"
WELCOME_COL_NYABO = "Нябо"
WELCOME_STEPS = [
	("Баримтын зургаа илгээнэ", "уншиж, дансны саналыг картаар илгээнэ"),
	("«Батлах» дарна", "ERPNext-д бичилт хийнэ"),
	("Асуултаа бичнэ", "дэвтрээс тоо гаргаж хариулна"),
]

# --- demo entries for a test company (setup.demo) -------------------------------------------------
MSG_DEMO_NO_COMPANY = "«{company}» нэртэй компани алга."
MSG_DEMO_LEDGER_NOT_EMPTY = (
	"«{company}» компанийн дэвтэрт бичилт байгаа тул жишээ өгөгдөл оруулахгүй: жишээ өгөгдөл "
	"зөвхөн хоосон туршилтын дэвтэрт зориулагдсан."
)

# --- the Mini App («Дэлгэрэнгүй самбар», nyabo_mn.miniapp) --------------------------------------
BTN_MINI_APP = "Дэлгэрэнгүй самбар"
BTN_MINIAPP_EXPORT = "Excel татах"
MSG_MINIAPP_BAD_INITDATA = (
	"Telegram-аас ирсэн мэдээлэл баталгаажсангүй. Самбарыг Нябо ботын товчноос дахин нээнэ үү."
)
