...
FORM_CASH_RECEIPT_VOUCHER = "Кассын орлогын ордер"
FORM_CASH_PAYMENT_VOUCHER = "Кассын зарлагын ордер"
FORM_INVOICE = "Нэхэмжлэх"
FORM_PAYMENT_ORDER_LIST = "Төлбөрийн даалгаврын жагсаалт"
FORM_PROVISIONAL_WATERMARK = "ТҮР МАЯГТ — Сангийн яамны баталсан маягтаар солино"
...
MSG_REGIME_MISSING = "{date} огноонд компанийн татварын горим тохируулаагүй байна. /эхлэх командаар тохируулна уу."
