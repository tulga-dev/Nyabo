"""Fixtures for the receipt pipeline flows: a company with regimes, verified patterns, a mock LLM
and a mock ebarimt provider, and a helper that stores a receipt photo as a Nyabo Document."""
